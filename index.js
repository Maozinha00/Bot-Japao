...
client.on('messageCreate', async (message) => {
  ...
  if (command === 'painel') {
    ...
    // Linha de botões incluindo o botão interativo "Retirar Aço 📤"
  ...
  // COMANDO: !retirar <quantidade> (Comando direto no chat)
  if (command === 'retirar') {
...
// Suporte a interações de botões e formulário Modal
client.on('interactionCreate', async (interaction) => {
  ...
  if (interaction.isButton()) {
    ...
    // BOTÃO: Retirar Aço (Abre a janela popup Modal)
  ...
  // Resposta ao envio do formulário Modal
